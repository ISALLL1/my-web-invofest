...
const Seminar = () => {
  ...
  const detailPelaksanaan = [
    { icon: <Calendar />, label: "Tanggal", value: "Kamis, 27 November 2025" },
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* --- TENTANG --- */}
      <section className="py-24 bg-zinc-50 rounded-[3rem] mx-4 md:mx-6 px-6 text-center">
        ...
        <p className="max-w-4xl mx-auto text-zinc-600 text-lg leading-relaxed">
          Seminar Nasional Teknologi Informasi ini hadir untuk menjawab
          tantangan kemajuan AI dengan mengubah paradigma dari kompetisi menjadi
          eksplorasi peluang kolaborasi. Kami mengupas tuntas bagaimana AI
          berfungsi sebagai mitra yang memperkuat kreativitas dan produktivitas
          manusia.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 max-w-4xl mx-auto justify-items-center">
      ...
      <section className="max-w-5xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {detailPelaksanaan.map((item, index) => (
            <div
              key={index}
      ...
      <section className="max-w-4xl mx-auto px-6 py-24">
        <div className="mb-16 text-center">
          ...
          <p className="text-zinc-500 font-medium">
            Temukan informasi tambahan seputar kegiatan seminar kami.
          </p>
        </div>
