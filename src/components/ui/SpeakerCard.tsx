    ...
    >
      <div className="relative h-1/3 z-1">
        <img
          src={imageUrl}
          alt={name}
          className="h-60 w-60 rounded-full border-10 border-red-900 
mx-auto group-hover:scale-105 transition-transform duration-300 
object-cover"
        />
      </div>
      <div
        className="cursor-pointer flex flex-col items-center h-2/3 
...
transition-all duration-300"
      >
        //card overlay
        <div
          className="absolute bottom-0 px-4 py-6 rounded-lg w-full 
